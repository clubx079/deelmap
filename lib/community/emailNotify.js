...
const FROM = 'DeelMap Community <noreply@deelmap.com>'
const LOGO_URL = 'https://sellerportaldeelmap-production-bea8.up.railway.app/deelmap.png'
...
export function emailVerificationRejected({ to, role, notes }) {
  ...
  sendCommunityEmail({
    ...
    html: shell({
      ...
      ctaHref: href,
      footerHint: 'Reach out to support@deelmap.com if you have questions about the review.',
    }),
  })
}
