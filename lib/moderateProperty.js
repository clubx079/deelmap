  ...
  try {
    const reply = await groqChat([{
      ...
      content: [
        ...
        { type: 'text', text: 'You are a strict content moderator for a real estate wholesale marketplace. Does this image show a real property photo — such as an exterior view, interior room, yard, garage, or other part of a physical building or land? Reply with exactly "PASS" only if it clearly shows real estate content. Reply "FAIL: <brief reason>" if the image is NOT a property photo (e.g. people, animals, food, memes, screenshots, documents, abstract art, cartoons, random objects, nature scenery without structures, or anything unrelated to a property).' }
      ]
