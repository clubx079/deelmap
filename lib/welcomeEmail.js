    ...
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff">
      ...
      <tr>
        <td style="background:#ffffff;border-top:1px solid #E8E8E4;padding:20px 40px;text-align:center">
          <p style="margin:0 0 4px;font-size:12px;color:#A8A8A4">Questions? Reach us at <a href="mailto:support@deelmap.com" style="color:#737370;text-decoration:none">support@deelmap.com</a></p>
