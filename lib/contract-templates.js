...
export const TEMPLATE_CONFIG = {
  ...
  '3801788': /* local DocuSeal */ {
    ...
    description: "Use this when you're selling a property to a buyer. You sign as the Seller; the buyer signs as the Buyer.",
    sortOrder: 1,
    fieldMap: {
  ...
  '4113504': /* staging DocuSeal Purchase v4 — co-seller signer; REPLACES 3802527 */ null,
...
// v4 Purchase: adds a dedicated "Co-Seller" role so the optional second seller is
// a real, conditional signer. seller2_print_name/seller2_signature live on that
// role now, so they only appear when a Co-Seller submitter is added.
TEMPLATE_CONFIG['4113504'] = TEMPLATE_CONFIG['3801788']
