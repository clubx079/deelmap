...
export function normalizeWholesaleDeal(deal) {
  ...
  return {
    ...
    // Coordinates for map — scraped deals use latitude/longitude; manual uses address_google_lat/lng
    address_google_lat: deal.address_google_lat || deal.latitude || null,
    address_google_lng: deal.address_google_lng || deal.longitude || null,
    latitude: deal.latitude || deal.address_google_lat || null,
    longitude: deal.longitude || deal.address_google_lng || null,
