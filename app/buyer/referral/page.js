...
export default function ReferralPage() {
  ...
  useEffect(() => {
    if (setPageTitle) setPageTitle('Referral')
  }, [setPageTitle])
  ...
  const generateCode = async () => {
    ...
    try {
      const res = await fetch('/api/referral', {
        ...
        body: JSON.stringify({ user_type: 'buyer' }),
      })
      const data = await res.json()
        ...
        <div className="bg-white border border-[#E8E8E4] rounded p-5">
          ...
          <div className="space-y-0">
            {[
              ...
              { step: '4', title: 'You earn 20%', desc: 'We calculate 20% of their original listing fee and send it to you monthly via Stripe.' },
