...
import { CheckCircle2, XCircle, Shield, Zap, DollarSign, Users } from 'lucide-react'

export const metadata = {
  title: 'DeelMap vs InvestorLift — Which Platform Is Right for You?',
  description: 'Compare DeelMap and InvestorLift side by side. See which wholesale real estate platform offers better deal volume, verification, buyer tools, and value.',
  keywords: 'DeelMap vs InvestorLift, InvestorLift alternative, wholesale real estate platform comparison, best real estate investing platform',
}
...
const COMPARISON_ROWS = [
  {
    ...
    deelmap: { positive: true, text: 'Always free — no subscription, no hidden fees' },
    competitor: { positive: false, text: 'Paid plans required to access full deal inventory' },
  },
  {
    feature: 'Deal Volume',
    deelmap: { positive: true, text: '10,000+ verified wholesale deals nationwide' },
    competitor: { positive: false, text: 'Coverage concentrated in select markets' },
  },
  {
    feature: 'Seller Verification',
    deelmap: { positive: true, text: 'Identity-verified on every listing before going live' },
    competitor: { positive: false, text: 'Basic onboarding — seller credentials not independently verified' },
  },
  {
    feature: 'Buyer Analysis Tools',
    deelmap: { positive: true, text: 'ARV estimates, spread data, and ROI breakdowns on each deal' },
    competitor: { positive: false, text: 'Limited filtering; deal analysis requires external tools' },
  },
  {
    feature: 'ARV Data',
    deelmap: { positive: true, text: 'Automated ARV included on every property listing' },
    competitor: { positive: false, text: 'ARV data not provided — investor calculates independently' },
  },
  {
    feature: 'Free for Buyers',
    deelmap: { positive: true, text: 'Yes — browse, analyze, and contact sellers at no cost' },
    competitor: { positive: false, text: 'No — paid plan required for full platform access' },
  },
  {
    feature: 'Mobile Experience',
    deelmap: { positive: true, text: 'Fully responsive — works on any device without a native app' },
    competitor: { positive: false, text: 'Interface optimized for desktop; limited mobile usability' },
  },
  {
...
const BENEFITS = [
  ...
  },
  {
    ...
    description: 'Before any listing goes live, the seller\'s identity is verified. You know exactly who you\'re dealing with before you reach out.',
  },
  {
    icon: Zap,
    title: 'Deal data built in',
    description: 'ARV, spread, and property details are structured on every listing. Evaluate a deal in minutes, not hours.',
  },
  {
    icon: Users,
    title: 'Direct communication',
    description: 'No middlemen. Message verified sellers directly through our secure platform and move to contract on your timeline.',
  },
]

export default function VsInvestorLiftPage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-[72px]">
          ...
          <div className="rounded border border-[#E8E8E4] overflow-hidden">
            ...
            <div className="grid grid-cols-3 bg-[#1A1816]">
              ...
              <div className="p-4 lg:p-5 border-l border-[#2D2A27]">
                <p className="text-[14px] font-bold text-[#737370]">InvestorLift</p>
              </div>
            </div>
      ...
      <section className="py-14 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-[72px]">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1A1816] mb-10 text-center">Built for buyers, not just sellers</h2>
      ...
      <section className="py-14 lg:py-20 bg-white">
        <div className="max-w-[680px] mx-auto px-6 text-center">
          ...
          <p className="text-[16px] text-[#444441] leading-relaxed mb-8">
            No subscription. No credit card. Browse thousands of verified wholesale deals and contact sellers directly — at no cost to you.
          </p>
          <Link
            href="/marketplace"
            className="inline-flex items-center gap-2 h-12 px-8 bg-[#D03839] hover:bg-[#E0493B] text-white font-semibold rounded transition-colors"
